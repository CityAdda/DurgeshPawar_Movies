...
import com.durgesh.moviefindermvvm.databinding.ActivityHomeBinding
import com.durgesh.moviefindermvvm.ui.adapter.CustomAdapterMovies
import com.durgesh.moviefindermvvm.ui.moviedetail.MovieDetailScrollingActivity
import com.durgesh.moviefindermvvm.util.*
                        ...
                        override fun onItemClick(view: View, position: Int) {
                            if (customAdapterMovies.getData().isNotEmpty()) {
                                ...
                                searchItem?.let {
                                    ...
                                    intent.putExtra(AppConstant.INTENT_POSTER, it?.multimedia?.src)
                                    intent.putExtra(AppConstant.INTENT_TITLE, it?.displayTitle)
                                    intent.putExtra(AppConstant.INTENT_HEADLINE, it?.headline)
                                    intent.putExtra(AppConstant.INTENT_SUMMERY, it?.summaryShort)
